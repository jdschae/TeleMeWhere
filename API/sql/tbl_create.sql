...
CREATE TABLE Model(modelid INT NOT NULL, username VARCHAR(20), creationdate TIMESTAMP DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY(modelid));
CREATE TABLE Marker(markerid INT NOT NULL, modelid INT NOT NULL, x FLOAT(10,5), y FLOAT(10,5), z FLOAT(10,5), creationdate TIMESTAMP DEFAULT CURRENT_TIMESTAMP, message VARCHAR(500), PRIMARY KEY(markerid));
