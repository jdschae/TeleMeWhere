...
CREATE TABLE Marker(markerid INT NOT NULL AUTO_INCREMENT, modelid INT NOT NULL, x FLOAT(10,5), y FLOAT(10,5), z FLOAT(10,5), creationdate TIMESTAMP DEFAULT CURRENT_TIMESTAMP, message VARCHAR(500), color VARCHAR(20), shape VARCHAR(20), rw FLOAT(10,5), rx FLOAT(10,5), ry FLOAT(10,5), rz FLOAT(10,5), PRIMARY KEY(markerid));
